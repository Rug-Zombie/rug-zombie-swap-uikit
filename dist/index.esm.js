...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://bscscan.com/address/0x50ba8BF9E34f0F83F96a340387d1d3888BA4B3b5", target: "_blank" },
        React__default.createElement("img", { alt: "zombie icon", src: "https://storage.googleapis.com/rug-zombie/low-hq-logo.png", style: { width: "30px", marginRight: "8px" } }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#000000", backgroundDisabled: "#007737", backgroundAlt: "#101820", backgroundAlt2: "#101820", cardBorder: "#b4bd00", contrast: "#191326", dropdown: "#007737", dropdownDeep: "#007737", invertedContrast: "#007737", input: "#007737", inputSecondary: "#d7caec", tertiary: "#007737", text: "#b4bd00", textDisabled: "#BDC2C4", textSubtle: "#b4bd00", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#000000", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var Logo = function (_a) {
    ...
    return (React__default.createElement(Flex, null, isAbsoluteUrl ? (React__default.createElement(StyledLink, { as: "a", href: href, "aria-label": "Pancake home page" },
        React__default.createElement("img", { alt: "", src: RugZombieLogo, style: { width: "130px" } }))) : (React__default.createElement(StyledLink, { to: href, "aria-label": "Pancake home page" },
        React__default.createElement("img", { alt: "", src: RugZombieLogo, style: { width: "130px" } })))));
};
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default.createElement(StyledIconMobileContainer, { display: ["block", null, "none"] },
                React__default.createElement(Logo$1, { isDark: false, href: "https://www.rugzombie.io/" })),
                ...
                items.map(function (item) {
                    ...
                    return (React__default.createElement(StyledList, { key: item.label },
                        ...
                        _a.map(function (_a) {
                            ...
                            return (React__default.createElement(StyledListItem, { key: label }, href ? (React__default.createElement(Link, { href: href, target: "_blank", rel: "noreferrer noopener", color: isHighlighted ? baseColors.warning : lightColors.text, bold: false }, label)) : (React__default.createElement(StyledText, null, label))));
                        })));
                }),
                React__default.createElement(Box, { display: ["none", null, "block"] },
                    React__default.createElement("img", { alt: "", src: RugZombieLogo, style: { width: "160px" } }))),
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default.createElement(Flex, { order: [2, null, 1], alignItems: "center" },
                    React__default.createElement(LangSelector$1, { currentLang: currentLang, langs: langs, setLang: setLang, color: lightColors.textSubtle, dropdownPosition: "top-right" })),
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://swap.rugzombie.io/swap?outputCurrency=0x50ba8BF9E34f0F83F96a340387d1d3888BA4B3b5", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$24, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
        ...
        React__default.createElement(FixedContainer, { showMenu: showMenu, height: totalTopMenuHeight },
            ...
            React__default.createElement(StyledNav, null,
                React__default.createElement(Flex, null,
                    React__default.createElement(Logo$1, { isDark: isDark, href: "https://www.rugzombie.io/" }),
