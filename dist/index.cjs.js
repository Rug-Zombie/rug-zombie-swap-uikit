...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://bscscan.com/address/0x50ba8BF9E34f0F83F96a340387d1d3888BA4B3b5", target: "_blank" },
        React__default['default'].createElement("img", { alt: "zombie icon", src: "https://storage.googleapis.com/rug-zombie/low-hq-logo.png", style: { width: "30px", marginRight: "8px" } }),
                ...
                items.map(function (item) {
                    ...
                    return (React__default['default'].createElement(StyledList, { key: item.label },
                        ...
                        _a.map(function (_a) {
                            ...
                            return (React__default['default'].createElement(StyledListItem, { key: label }, href ? (React__default['default'].createElement(Link, { href: href, target: "_blank", rel: "noreferrer noopener", color: isHighlighted ? baseColors.warning : lightColors.text, bold: false }, label)) : (React__default['default'].createElement(StyledText, null, label))));
                        })));
                }),
                React__default['default'].createElement(Box, { display: ["none", null, "block"] },
                    React__default['default'].createElement("img", { alt: "", src: RugZombieLogo, style: { width: "160px" } }))),
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    React__default['default'].createElement(Box, { mr: "20px" },
                        React__default['default'].createElement(CakePrice$1, { cakePriceUsd: cakePriceUsd, color: lightColors.textSubtle })),
                    React__default['default'].createElement(Button, { as: "a", href: "https://swap.rugzombie.io/swap?outputCurrency=0x50ba8BF9E34f0F83F96a340387d1d3888BA4B3b5", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$24, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
